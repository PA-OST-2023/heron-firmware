...
class AS5600
{
 public:
  ...
  static constexpr const uint8_t AS5600_ZMCO = 0x00;
  static constexpr const uint8_t AS5600_ZPOS = 0x01;    //  + 0x02
  static constexpr const uint8_t AS5600_MPOS = 0x03;    //  + 0x04
  static constexpr const uint8_t AS5600_MANG = 0x05;    //  + 0x06
  static constexpr const uint8_t AS5600_CONF = 0x07;    //  + 0x08

  //  CONFIGURATION BIT MASKS - byte level
  static constexpr const uint8_t AS5600_CONF_POWER_MODE = 0x03;
  static constexpr const uint8_t AS5600_CONF_HYSTERESIS = 0x0C;
  static constexpr const uint8_t AS5600_CONF_OUTPUT_MODE = 0x30;
  static constexpr const uint8_t AS5600_CONF_PWM_FREQUENCY = 0xC0;
  static constexpr const uint8_t AS5600_CONF_SLOW_FILTER = 0x03;
  static constexpr const uint8_t AS5600_CONF_FAST_FILTER = 0x1C;
  static constexpr const uint8_t AS5600_CONF_WATCH_DOG = 0x20;

  //  UNKNOWN REGISTERS 0x09-0x0A

  //  OUTPUT REGISTERS
  static constexpr const uint8_t AS5600_RAW_ANGLE = 0x0C;    //  + 0x0D
  static constexpr const uint8_t AS5600_ANGLE = 0x0E;        //  + 0x0F

  // I2C_ADDRESS REGISTERS (AS5600L)
  static constexpr const uint8_t AS5600_I2CADDR = 0x20;
  static constexpr const uint8_t AS5600_I2CUPDT = 0x21;

  //  STATUS REGISTERS
  static constexpr const uint8_t AS5600_STATUS = 0x0B;
  static constexpr const uint8_t AS5600_AGC = 0x1A;
  static constexpr const uint8_t AS5600_MAGNITUDE = 0x1B;    //  + 0x1C
  static constexpr const uint8_t AS5600_BURN = 0xFF;

  //  STATUS BITS
  static constexpr const uint8_t AS5600_MAGNET_HIGH = 0x08;
  static constexpr const uint8_t AS5600_MAGNET_LOW = 0x10;
