...
// #define MEM_CUSTOM_ALLOCATOR 1  /* opt.h sets to 1 if MEM_LIBC_MALLOC */
// #define MEM_CUSTOM_FREE      extmem_free
// #define MEM_CUSTOM_MALLOC    extmem_malloc
// #define MEM_CUSTOM_CALLOC    extmem_calloc
