...
void setup_scr_screen_ambient(lv_ui *ui)
{
	...
	lv_obj_set_style_text_line_space(ui->screen_ambient_label_title, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_meter_indicator_t *screen_ambient_meter_temperature_scale_1_arc_0;
	screen_ambient_meter_temperature_scale_1_arc_0 = lv_meter_add_arc(ui->screen_ambient_meter_temperature, screen_ambient_meter_temperature_scale_1, 10, lv_color_hex(0x757478), -1);
	lv_meter_set_indicator_start_value(ui->screen_ambient_meter_temperature, screen_ambient_meter_temperature_scale_1_arc_0, 0);
	lv_meter_set_indicator_end_value(ui->screen_ambient_meter_temperature, screen_ambient_meter_temperature_scale_1_arc_0, 100);

	// add arc for screen_ambient_meter_temperature_scale_1
	lv_meter_indicator_t *screen_ambient_meter_temperature_scale_1_arc_1;
	screen_ambient_meter_temperature_scale_1_arc_1 = lv_meter_add_arc(ui->screen_ambient_meter_temperature, screen_ambient_meter_temperature_scale_1, 10, lv_color_hex(0x00ff16), -1);
	lv_meter_set_indicator_start_value(ui->screen_ambient_meter_temperature, screen_ambient_meter_temperature_scale_1_arc_1, 0);
	lv_meter_set_indicator_end_value(ui->screen_ambient_meter_temperature, screen_ambient_meter_temperature_scale_1_arc_1, 0);
	...
	lv_meter_indicator_t *screen_ambient_meter_pressure_scale_1_arc_0;
	screen_ambient_meter_pressure_scale_1_arc_0 = lv_meter_add_arc(ui->screen_ambient_meter_pressure, screen_ambient_meter_pressure_scale_1, 10, lv_color_hex(0x757478), -1);
	lv_meter_set_indicator_start_value(ui->screen_ambient_meter_pressure, screen_ambient_meter_pressure_scale_1_arc_0, 0);
	lv_meter_set_indicator_end_value(ui->screen_ambient_meter_pressure, screen_ambient_meter_pressure_scale_1_arc_0, 100);

	// add arc for screen_ambient_meter_pressure_scale_1
	lv_meter_indicator_t *screen_ambient_meter_pressure_scale_1_arc_1;
	screen_ambient_meter_pressure_scale_1_arc_1 = lv_meter_add_arc(ui->screen_ambient_meter_pressure, screen_ambient_meter_pressure_scale_1, 10, lv_color_hex(0x2195f6), -1);
	lv_meter_set_indicator_start_value(ui->screen_ambient_meter_pressure, screen_ambient_meter_pressure_scale_1_arc_1, 0);
	lv_meter_set_indicator_end_value(ui->screen_ambient_meter_pressure, screen_ambient_meter_pressure_scale_1_arc_1, 0);
