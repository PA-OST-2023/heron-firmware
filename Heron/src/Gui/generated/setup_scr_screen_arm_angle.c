...
FLASHMEM void setup_scr_screen_arm_angle(lv_ui *ui)
{
	...
	ui->screen_arm_angle_meter_angle_scale_1_arc_0 = lv_meter_add_arc(ui->screen_arm_angle_meter_angle, screen_arm_angle_meter_angle_scale_1, 14, lv_color_hex(0x757478), -1);
	lv_meter_set_indicator_start_value(ui->screen_arm_angle_meter_angle, ui->screen_arm_angle_meter_angle_scale_1_arc_0, 0);
	lv_meter_set_indicator_end_value(ui->screen_arm_angle_meter_angle, ui->screen_arm_angle_meter_angle_scale_1_arc_0, 90);

	// add arc for screen_arm_angle_meter_angle_scale_1
	ui->screen_arm_angle_meter_angle_scale_1_arc_1 = lv_meter_add_arc(ui->screen_arm_angle_meter_angle, screen_arm_angle_meter_angle_scale_1, 14, lv_color_hex(0xD200AC), -1);
	lv_meter_set_indicator_start_value(ui->screen_arm_angle_meter_angle, ui->screen_arm_angle_meter_angle_scale_1_arc_1, 0);
	lv_meter_set_indicator_end_value(ui->screen_arm_angle_meter_angle, ui->screen_arm_angle_meter_angle_scale_1_arc_1, 0);
