...
typedef struct
{
	...
	lv_obj_t *screen_bootup_label_project;
	lv_obj_t *screen_bootup_img_heron;
	lv_obj_t *screen_bootup_label_version;
	lv_obj_t *screen_bootup_img_icai;
	lv_obj_t *screen_bootup_label_names;
	lv_obj_t *screen_bootup_label_year;
	lv_obj_t *screen_bootup_label_heron;
