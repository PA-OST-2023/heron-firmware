...
ST7735_t3::ST7735_t3(uint8_t cs, uint8_t rs, uint8_t sid, uint8_t sclk, uint8_t rst)
{
	...
	_dma_state = 0;
    #endif
	_screenHeight = ST7789V_TFTHEIGHT_240;
	_screenWidth = ST7789V_TFTWIDTH_240;	
...
static const uint8_t PROGMEM
  Bcmd[] = {                  // Initialization commands for 7735B screens
    ...
    //   0x0,                    //     Line inversion
	ST7735_INVON ,   DELAY,  //  8: Inversion on, no args, w/delay
	  10,                     //     10 ms delay
    ...
    ST7735_PWCTR6 , 2      ,  // 12: Power control, 2 args, no delay:
      0x11, 0x15,
	ST7735_GMCTRP1, 14      , //  1: Magical unicorn dust, 16 args, no delay:
      0xD0, 0x00, 0x05, 0x0E,
      0x15, 0x0D, 0x37, 0x43,
      0x47, 0x09, 0x15, 0x12,
      0x16, 0x19,
    ST7735_GMCTRN1, 14      , //  2: Sparkles and rainbows, 16 args, no delay:
      0xD0, 0x00, 0x05, 0x0D,
      0x0C, 0x06, 0x2D, 0x44,
      0x40, 0x0E, 0x1C, 0x18,
      0x16, 0x19,
    ...
    ST7735_RASET  , 4      ,  // 16: Row addr set, 4 args, no delay:
      0x00, 0x00,             //     XSTART = 0
      0x00, 240,             //     XEND = 240
    ST7735_NORON  ,   DELAY,  // 18: Normal display on, no args, w/delay
      10,                     //     10 ms delay
    ST7735_DISPON ,   DELAY,  // 19: Main screen turn on, no args, w/delay
      255 },                  //     255 = 500 ms delay
